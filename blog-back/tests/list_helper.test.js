...
describe('favorite blog', () => {
  ...
  test('of a bigger list equals blog with most likes', () => {
...
describe('most blogs', () => {
  ...
  test('of a bigger list equals author with how many blogs they have', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, equals that author with number of likes', () => {
  ...
  test('of a bigger list equals author with most number of likes', () => {
